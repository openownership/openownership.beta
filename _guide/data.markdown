...
layout: guide-page
description: |-
  In this section, the following will be examined: how to scope out the information collected within declarations; how to implement mechanisms to improve data quality according to the OO Principle of [verification](/principles/verified/); and the importance of standardised, well-[structured data](/principles/structured-data/). OO has also developed a prototyping tool for a basic system for collecting BO data.
principles:
- Verified
- Structured data
